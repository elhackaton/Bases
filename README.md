...
* Todos los proyectos deben incluir un archivo ```README.md``` que incluya la siguiente información: componentes del equipo, descripción del proyecto, especificaciones técnicas y el tipo de licencia bajo la que se libera el proyecto. [Ejemplo]. 
